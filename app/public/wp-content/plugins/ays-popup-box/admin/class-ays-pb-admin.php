...
class Ays_Pb_Admin {
	...
	public function enqueue_scripts($hook_suffix) {
        ...
        wp_enqueue_media();
		wp_enqueue_script( $this->plugin_name . '-popper-js', plugin_dir_url(__FILE__) . '/js/popper.min.js', array( 'jquery' ), $this->version, true );
        ...
        wp_enqueue_script( $this->plugin_name . '-select2-js', plugin_dir_url(__FILE__) . '/js/select2.min.js', array('jquery'), $this->version, true );
        wp_enqueue_script( $this->plugin_name . '-sweetalert-js', plugin_dir_url(__FILE__) . '/js/ays-pb-sweetalert2.all.min.js', array('jquery'), $this->version, true );
